...
As you read the code, pronounce `%>%` as "then". You'll notice that `dplyr` makes it easy to read pipes. Each function name is a verb, so our code resembles the statement, "Take spotify, _then_ filter it by covid_period, _then_ select the loudness and energy."
